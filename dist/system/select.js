System.register(['aurelia-framework', './utils', './Store'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var aurelia_framework_1, utils_1, Store_1;
    ...
    function select(selector, config) {
        ...
        return function (target, propertyKey) {
            aurelia_framework_1.metadata.define(SELECTOR_METADATA_KEY, true, target, propertyKey);
